...
/// IM 开始重连(IM 会一直重连至成功)
/// @param connection  当前连接
- (void)lelinkConnectionIMDidStartRetryConnect:(LBLelinkConnection *)connection;

/// IM 重连成功
/// @param connection 当前连接
- (void)lelinkConnectionRetryConnectIMSuccessfully:(LBLelinkConnection *)connection;
